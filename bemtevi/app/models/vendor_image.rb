class VendorImage < Asset
  ...
  has_attached_file :attachment,
                    ...
                    :url => "/assets/vendors/:id/:style/:basename.:extension",
                    :path => ":rails_root/public/assets/vendors/:id/:style/:basename.:extension"
  ...
  def type
    ...
    return "banner" if self.attachment_aspect_ratio >= 3
    "icon"
  end
